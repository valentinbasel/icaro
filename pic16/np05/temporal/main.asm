...
; This file was generated Sun Jun 16 19:42:01 2013
;--------------------------------------------------------
...
_high_priority_isr:
;	.line	98; /home/valentin/.icaro/np05/source/main.c	void high_priority_isr(void) __interrupt
	MOVFF	WREG, POSTDEC1
...
;	.line	111; /home/valentin/.icaro/np05/source/main.c	if(PIR2bits.USBIF)
	BTFSS	_PIR2bits, 5
	BRA	_00678_DS_
;	.line	113; /home/valentin/.icaro/np05/source/main.c	dispatch_usb_event();
	CALL	_dispatch_usb_event
;	.line	114; /home/valentin/.icaro/np05/source/main.c	UIRbits.SOFIF = 0;
	BCF	_UIRbits, 6
;	.line	115; /home/valentin/.icaro/np05/source/main.c	UIRbits.URSTIF = 0;
	BCF	_UIRbits, 0
;	.line	116; /home/valentin/.icaro/np05/source/main.c	PIR2bits.USBIF = 0;
	BCF	_PIR2bits, 5
;	.line	117; /home/valentin/.icaro/np05/source/main.c	UEIR = 0;
	CLRF	_UEIR
_00678_DS_:
;	.line	134; /home/valentin/.icaro/np05/source/main.c	servos_interrupt();
...
_low_priority_isr:
;	.line	142; /home/valentin/.icaro/np05/source/main.c	void low_priority_isr(void) __interrupt
	MOVFF	WREG, POSTDEC1
	MOVFF	STATUS, POSTDEC1
	MOVFF	BSR, POSTDEC1
	MOVFF	PRODL, POSTDEC1
	...
	MOVFF	PCLATH, POSTDEC1
	MOVFF	PCLATU, POSTDEC1
;	.line	144; /home/valentin/.icaro/np05/source/main.c	}
	MOVFF	PREINC1, PCLATU
	MOVFF	PREINC1, PCLATH
	MOVFF	PREINC1, FSR0H
	MOVFF	PREINC1, FSR0L
...
_pinguino_main:
;	.line	54; /home/valentin/.icaro/np05/source/main.c	PIE1=0;
	CLRF	_PIE1
;	.line	55; /home/valentin/.icaro/np05/source/main.c	PIE2=0;
	CLRF	_PIE2
;	.line	56; /home/valentin/.icaro/np05/source/main.c	ADCON1=0x0F;
	MOVLW	0x0f
	MOVWF	_ADCON1
;	.line	58; /home/valentin/.icaro/np05/source/main.c	PIE2bits.USBIE = 1;
	BSF	_PIE2bits, 5
;	.line	59; /home/valentin/.icaro/np05/source/main.c	INTCON = 0xC0;
	MOVLW	0xc0
	MOVWF	_INTCON
;	.line	61; /home/valentin/.icaro/np05/source/main.c	setup();
	CALL	_setup
;	.line	63; /home/valentin/.icaro/np05/source/main.c	analog_init();
	CALL	_analog_init
;	.line	69; /home/valentin/.icaro/np05/source/main.c	servos_init();
	CALL	_servos_init
;	.line	85; /home/valentin/.icaro/np05/source/main.c	INTCONbits.PEIE=1;
	BSF	_INTCONbits, 6
;	.line	86; /home/valentin/.icaro/np05/source/main.c	INTCONbits.GIE=1;
	BSF	_INTCONbits, 7
_00670_DS_:
;	.line	91; /home/valentin/.icaro/np05/source/main.c	loop();
	CALL	_loop
	BRA	_00670_DS_
	RETURN	
...
S_main__loop	code
_loop:
;	.line	66; /home/valentin/.icaro/np05/source/user.c	void loop()
	MOVFF	r0x00, POSTDEC1
;	.line	68; /home/valentin/.icaro/np05/source/user.c	if (usbavailable())
	CALL	_usbavailable
	MOVWF	r0x00
	MOVF	r0x00, W
	BTFSC	STATUS, 2
	BRA	_00656_DS_
;	.line	70; /home/valentin/.icaro/np05/source/user.c	received_char=usbread();
	CALL	_usbread
; #	MOVWF	r0x00
; #	MOVF	r0x00, W
; #	MOVWF	_received_char, B
; #	MOVF	_received_char, W, B
	BANKSEL	_received_char
;	.line	71; /home/valentin/.icaro/np05/source/user.c	if (received_char=='L')
	MOVWF	_received_char, B
	XORLW	0x4c
	BNZ	_00651_DS_
;	.line	73; /home/valentin/.icaro/np05/source/user.c	ServoWrite(10,100);
	MOVLW	0x64
	MOVWF	POSTDEC1
	MOVLW	0x0a
	MOVWF	POSTDEC1
	...
	ADDWF	FSR1L, F
	BANKSEL	_received_char
;	.line	74; /home/valentin/.icaro/np05/source/user.c	usbsend(received_char,4);
	MOVF	_received_char, W, B
	MOVWF	r0x00
	CLRF	POSTDEC1
	MOVLW	0x04
	...
	MOVLW	0x05
	ADDWF	FSR1L, F
;	.line	75; /home/valentin/.icaro/np05/source/user.c	Delayms(1000);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x03
	MOVWF	POSTDEC1
...
_00651_DS_:
	BANKSEL	_received_char
;	.line	78; /home/valentin/.icaro/np05/source/user.c	if (received_char=='A')
	MOVF	_received_char, W, B
	XORLW	0x41
	BNZ	_00656_DS_
;	.line	80; /home/valentin/.icaro/np05/source/user.c	ServoWrite(10,20);
	MOVLW	0x14
	MOVWF	POSTDEC1
	MOVLW	0x0a
	MOVWF	POSTDEC1
	...
	ADDWF	FSR1L, F
	BANKSEL	_received_char
;	.line	81; /home/valentin/.icaro/np05/source/user.c	usbsend(received_char,4);
	MOVF	_received_char, W, B
	MOVWF	r0x00
	CLRF	POSTDEC1
	MOVLW	0x04
	...
	MOVLW	0x05
	ADDWF	FSR1L, F
;	.line	82; /home/valentin/.icaro/np05/source/user.c	Delayms(1000);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x03
	MOVWF	POSTDEC1
...
_epapout_init:
;	.line	146; /home/valentin/.icaro/np05/tmp/usb.c	EP_OUT_BD(1).Cnt = EP1_BUFFER_SIZE;
	MOVLW	0x40
	BANKSEL	(_ep_bdt + 9)
	MOVWF	(_ep_bdt + 9), B
;	.line	147; /home/valentin/.icaro/np05/tmp/usb.c	EP_OUT_BD(1).ADR = (uchar __data *)&RXbuffer;
	MOVLW	LOW(_RXbuffer)
...
; removed redundant BANKSEL
	MOVWF	(_ep_bdt + 11), B
;	.line	148; /home/valentin/.icaro/np05/tmp/usb.c	EP_OUT_BD(1).Stat.uc = BDS_USIE | BDS_DAT0 | BDS_DTSEN;
	MOVLW	0x88
; removed redundant BANKSEL
	MOVWF	(_ep_bdt + 8), B
;	.line	149; /home/valentin/.icaro/np05/tmp/usb.c	UEP1 = EPHSHK_EN | EPOUTEN_EN | EPCONDIS_EN;       	// Init EPAPPLI as an OUT EP
	MOVLW	0x1c
	MOVWF	_UEP1
; #	MOVLW	0x01
; #	MOVWF	_usbwp, B
; #	MOVLW	0x01
;	.line	150; /home/valentin/.icaro/np05/tmp/usb.c	usbwp=1;						// init pointer for rx buffer pinguino
	MOVLW	0x01
	BANKSEL	_usbwp
;	.line	151; /home/valentin/.icaro/np05/tmp/usb.c	usbrp=1;
	MOVWF	_usbwp, B
	BANKSEL	_usbrp
	MOVWF	_usbrp, B
	RETURN	
...
_epap_out:
;	.line	110; /home/valentin/.icaro/np05/tmp/usb.c	void epap_out(void)
	MOVFF	r0x00, POSTDEC1
	MOVFF	r0x01, POSTDEC1
	MOVFF	r0x02, POSTDEC1
	MOVFF	r0x03, POSTDEC1
;	.line	116; /home/valentin/.icaro/np05/tmp/usb.c	if((EP_OUT_BD(1).Cnt >= 1) && ( EP_OUT_BD(1).Cnt<EP1_BUFFER_SIZE))
	MOVLW	0x01
	BANKSEL	(_ep_bdt + 9)
	SUBWF	(_ep_bdt + 9), W, B
	BTFSS	STATUS, 0
...
; removed redundant BANKSEL
	...
	BTFSC	STATUS, 0
	BRA	_00566_DS_
;	.line	118; /home/valentin/.icaro/np05/tmp/usb.c	for (cpt=0;cpt<EP_OUT_BD(1).Cnt;cpt++)
	CLRF	r0x00
_00569_DS_:
	BANKSEL	(_ep_bdt + 9)
	MOVF	(_ep_bdt + 9), W, B
	SUBWF	r0x00, W
	BC	_00572_DS_
;	.line	120; /home/valentin/.icaro/np05/tmp/usb.c	caractere=RXbuffer[cpt];
	MOVLW	LOW(_RXbuffer)
	ADDWF	r0x00, W
	MOVWF	r0x01
	CLRF	r0x02
	...
	MOVFF	INDF0, r0x01
	BANKSEL	_usbwp
;	.line	121; /home/valentin/.icaro/np05/tmp/usb.c	if (usbwp!=USBRXSIZE-1) newusbwp=usbwp+1;               
	MOVF	_usbwp, W, B
	XORLW	0x3f
	BZ	_00556_DS_
_00588_DS_:
	...
	BRA	_00557_DS_
_00556_DS_:
;	.line	122; /home/valentin/.icaro/np05/tmp/usb.c	else newusbwp=1;
	MOVLW	0x01
	MOVWF	r0x02
_00557_DS_:
	BANKSEL	_usbrp
;	.line	123; /home/valentin/.icaro/np05/tmp/usb.c	if (usbrp!=newusbwp) usbrx[usbwp++]=caractere;
	MOVF	_usbrp, W, B
	XORWF	r0x02, W
	BZ	_00559_DS_
	MOVFF	_usbwp, r0x02
...
_00559_DS_:
	BANKSEL	_usbwp
;	.line	124; /home/valentin/.icaro/np05/tmp/usb.c	if (usbwp==USBRXSIZE) usbwp=1;
	MOVF	_usbwp, W, B
	XORLW	0x40
	BNZ	_00571_DS_
	MOVLW	0x01
...
;	.line	118; /home/valentin/.icaro/np05/tmp/usb.c	for (cpt=0;cpt<EP_OUT_BD(1).Cnt;cpt++)
	...
	BRA	_00569_DS_
_00572_DS_:
;	.line	126; /home/valentin/.icaro/np05/tmp/usb.c	EP_OUT_BD(1).Cnt = EP1_BUFFER_SIZE;
	MOVLW	0x40
	BANKSEL	(_ep_bdt + 9)
	MOVWF	(_ep_bdt + 9), B
; removed redundant BANKSEL
;	.line	127; /home/valentin/.icaro/np05/tmp/usb.c	if(EP_OUT_BD(1).Stat.DTS == 0)
	BTFSC	(_ep_bdt + 8), 6, B
	BRA	_00563_DS_
;	.line	129; /home/valentin/.icaro/np05/tmp/usb.c	EP_OUT_BD(1).Stat.uc = BDS_USIE | BDS_DAT1 | BDS_DTSEN;
	MOVLW	0xc8
; removed redundant BANKSEL
	MOVWF	(_ep_bdt + 8), B
	BRA	_00573_DS_
_00563_DS_:
;	.line	133; /home/valentin/.icaro/np05/tmp/usb.c	EP_OUT_BD(1).Stat.uc = BDS_USIE | BDS_DAT0 | BDS_DTSEN;
	MOVLW	0x88
	BANKSEL	(_ep_bdt + 8)
	MOVWF	(_ep_bdt + 8), B
	BRA	_00573_DS_
_00566_DS_:
;	.line	138; /home/valentin/.icaro/np05/tmp/usb.c	EP_OUT_BD(1).Cnt = EP1_BUFFER_SIZE;
	MOVLW	0x40
	BANKSEL	(_ep_bdt + 9)
	MOVWF	(_ep_bdt + 9), B
;	.line	139; /home/valentin/.icaro/np05/tmp/usb.c	EP_OUT_BD(1).ADR = (uchar __data *)&RXbuffer;
	MOVLW	LOW(_RXbuffer)
; removed redundant BANKSEL
	MOVWF	(_ep_bdt + 10), B
	MOVLW	HIGH(_RXbuffer)
; removed redundant BANKSEL
	MOVWF	(_ep_bdt + 11), B
;	.line	140; /home/valentin/.icaro/np05/tmp/usb.c	EP_OUT_BD(1).Stat.uc = BDS_USIE | BDS_BSTALL;
	MOVLW	0x84
; removed redundant BANKSEL
	MOVWF	(_ep_bdt + 8), B
_00573_DS_:
...
_usbread:
;	.line	97; /home/valentin/.icaro/np05/tmp/usb.c	uchar usbread()
	MOVFF	r0x00, POSTDEC1
	MOVFF	r0x01, POSTDEC1
	MOVFF	r0x02, POSTDEC1
;	.line	99; /home/valentin/.icaro/np05/tmp/usb.c	uchar caractere=0;
	CLRF	r0x00
;	.line	101; /home/valentin/.icaro/np05/tmp/usb.c	if (usbavailable)
	MOVF	LOW(_usbavailable), W
	IORWF	HIGH(_usbavailable), W
	IORWF	UPPER(_usbavailable), W
	BZ	_00544_DS_
;	.line	103; /home/valentin/.icaro/np05/tmp/usb.c	caractere=usbrx[usbrp++];
	MOVFF	_usbrp, r0x01
	BANKSEL	_usbrp
	INCF	_usbrp, F, B
	CLRF	r0x02
	...
	MOVFF	INDF0, r0x00
; removed redundant BANKSEL
;	.line	104; /home/valentin/.icaro/np05/tmp/usb.c	if (usbrp==USBRXSIZE)
	MOVF	_usbrp, W, B
	XORLW	0x40
	BNZ	_00544_DS_
;	.line	105; /home/valentin/.icaro/np05/tmp/usb.c	usbrp=1;
	MOVLW	0x01
	BANKSEL	_usbrp
	MOVWF	_usbrp, B
_00544_DS_:
;	.line	107; /home/valentin/.icaro/np05/tmp/usb.c	return(caractere);
	MOVF	r0x00, W
	MOVFF	PREINC1, r0x02
	MOVFF	PREINC1, r0x01
	MOVFF	PREINC1, r0x00
...
_epap_in:
;	.line	76; /home/valentin/.icaro/np05/tmp/usb.c	void epap_in(void)
	MOVFF	r0x00, POSTDEC1
	BANKSEL	_ep2_num_bytes_to_send
;	.line	78; /home/valentin/.icaro/np05/tmp/usb.c	if((ep2_num_bytes_to_send == 0) && last_send_was_null)
...
;	.line	80; /home/valentin/.icaro/np05/tmp/usb.c	return;
	MOVF	_last_send_was_null, W, B
;	.line	82; /home/valentin/.icaro/np05/tmp/usb.c	last_send_was_null = (ep2_num_bytes_to_send < EP2_BUFFER_SIZE);
	BNZ	_00530_DS_
_00525_DS_:
	MOVLW	0x00
...
_00536_DS_:
	...
	MOVF	r0x00, W
	BANKSEL	_last_send_was_null
	MOVWF	_last_send_was_null, B
; #	MOVF	_ep2_num_bytes_to_send, W, B
; #	MOVWF	r0x00
; #	MOVF	r0x00, W
	BANKSEL	_ep2_num_bytes_to_send
;	.line	83; /home/valentin/.icaro/np05/tmp/usb.c	EP_IN_BD(2).Cnt = ep2_num_bytes_to_send;
	MOVF	_ep2_num_bytes_to_send, W, B
	BANKSEL	(_ep_bdt + 21)
	MOVWF	(_ep_bdt + 21), B
;	.line	84; /home/valentin/.icaro/np05/tmp/usb.c	fill_in_buffer(2, &ep2_source_data, EP2_BUFFER_SIZE, &ep2_num_bytes_to_send);
	MOVLW	0x80
; #	MOVWF	r0x05
; #	MOVF	r0x05, W
	MOVWF	POSTDEC1
	...
	ADDWF	FSR1L, F
	BANKSEL	(_ep_bdt + 20)
;	.line	85; /home/valentin/.icaro/np05/tmp/usb.c	if(EP_IN_BD(2).Stat.DTS == 0)
	BTFSC	(_ep_bdt + 20), 6, B
	BRA	_00528_DS_
;	.line	87; /home/valentin/.icaro/np05/tmp/usb.c	EP_IN_BD(2).Stat.uc = BDS_USIE | BDS_DAT1 | BDS_DTSEN;
	MOVLW	0xc8
; removed redundant BANKSEL
	MOVWF	(_ep_bdt + 20), B
	BRA	_00530_DS_
_00528_DS_:
;	.line	91; /home/valentin/.icaro/np05/tmp/usb.c	EP_IN_BD(2).Stat.uc = BDS_USIE | BDS_DAT0 | BDS_DTSEN;
	MOVLW	0x88
	BANKSEL	(_ep_bdt + 20)
	MOVWF	(_ep_bdt + 20), B
_00530_DS_:
...
_usbsend:
;	.line	59; /home/valentin/.icaro/np05/tmp/usb.c	void usbsend(uchar *txpointer,uint length)
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1L, FSR2L
	MOVLW	0x02
...
;	.line	63; /home/valentin/.icaro/np05/tmp/usb.c	prepare_ep2_in();
...
_prepare_ep2_in:
;	.line	43; /home/valentin/.icaro/np05/tmp/usb.c	void prepare_ep2_in(void)
	MOVFF	r0x00, POSTDEC1
;	.line	45; /home/valentin/.icaro/np05/tmp/usb.c	last_send_was_null = (ep2_num_bytes_to_send < EP2_BUFFER_SIZE);
	MOVLW	0x00
	BANKSEL	(_ep2_num_bytes_to_send + 1)
	SUBWF	(_ep2_num_bytes_to_send + 1), W, B
	BNZ	_00514_DS_
...
; #	MOVF	r0x00, W
	BANKSEL	_ep2_num_bytes_to_send
;	.line	46; /home/valentin/.icaro/np05/tmp/usb.c	EP_IN_BD(2).Cnt = ep2_num_bytes_to_send;
	MOVF	_ep2_num_bytes_to_send, W, B
	BANKSEL	(_ep_bdt + 21)
	MOVWF	(_ep_bdt + 21), B
;	.line	47; /home/valentin/.icaro/np05/tmp/usb.c	EP_IN_BD(2).ADR = (uchar __data *)&TXBuffer;
	MOVLW	LOW(_TXBuffer)
; removed redundant BANKSEL
	MOVWF	(_ep_bdt + 22), B
...
; removed redundant BANKSEL
	MOVWF	(_ep_bdt + 23), B
;	.line	48; /home/valentin/.icaro/np05/tmp/usb.c	fill_in_buffer(2, &ep2_source_data, EP2_BUFFER_SIZE, &ep2_num_bytes_to_send);
	MOVLW	0x80
; #	MOVWF	r0x05
; #	MOVF	r0x05, W
	MOVWF	POSTDEC1
	...
	ADDWF	FSR1L, F
	BANKSEL	(_ep_bdt + 20)
;	.line	49; /home/valentin/.icaro/np05/tmp/usb.c	if(EP_IN_BD(2).Stat.DTS == 0)
	BTFSC	(_ep_bdt + 20), 6, B
	BRA	_00508_DS_
;	.line	51; /home/valentin/.icaro/np05/tmp/usb.c	EP_IN_BD(2).Stat.uc = BDS_USIE | BDS_DAT1 | BDS_DTSEN;
	MOVLW	0xc8
; removed redundant BANKSEL
	MOVWF	(_ep_bdt + 20), B
	BRA	_00510_DS_
_00508_DS_:
;	.line	55; /home/valentin/.icaro/np05/tmp/usb.c	EP_IN_BD(2).Stat.uc = BDS_USIE | BDS_DAT0 | BDS_DTSEN;
	MOVLW	0x88
	BANKSEL	(_ep_bdt + 20)
	MOVWF	(_ep_bdt + 20), B
_00510_DS_:
...
_epapin_init:
;	.line	39; /home/valentin/.icaro/np05/tmp/usb.c	EP_IN_BD(2).Stat.uc = BDS_UCPU | BDS_DAT1 | BDS_DTSEN;
	MOVLW	0x48
	BANKSEL	(_ep_bdt + 20)
	MOVWF	(_ep_bdt + 20), B
;	.line	40; /home/valentin/.icaro/np05/tmp/usb.c	UEP2 = EPHSHK_EN | EPINEN_EN |  EPCONDIS_EN;
	MOVLW	0x1a
	MOVWF	_UEP2
	RETURN	
...
_usbavailable:
;	.line	30; /home/valentin/.icaro/np05/tmp/usb.c	uchar usbavailable()
	MOVFF	r0x00, POSTDEC1
;	.line	32; /home/valentin/.icaro/np05/tmp/usb.c	return (usbwp!=usbrp);
	CLRF	r0x00
	BANKSEL	_usbwp
	MOVF	_usbwp, W, B
	BANKSEL	_usbrp
...
; Statistics:
; code size:	 6168 (0x1818) bytes ( 4.71%)
;           	 3084 (0x0c0c) words
; udata size:	  297 (0x0129) bytes (16.57%)
