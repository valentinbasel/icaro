...
; This file was generated Fri Mar  1 21:43:25 2013
;--------------------------------------------------------
...
_high_priority_isr:
;	.line	98; /home/valentin/.icaro/np05/source/main.c	void high_priority_isr(void) interrupt
	MOVFF	WREG, POSTDEC1
...
_low_priority_isr:
;	.line	142; /home/valentin/.icaro/np05/source/main.c	void low_priority_isr(void) interrupt
	MOVFF	WREG, POSTDEC1
	MOVFF	STATUS, POSTDEC1
	MOVFF	BSR, POSTDEC1
	MOVFF	PRODL, POSTDEC1
...
;	.line	69; /home/valentin/.icaro/np05/source/user.c	PORTD=96;
	MOVLW	0x60
	MOVWF	_PORTD
;	.line	70; /home/valentin/.icaro/np05/source/user.c	Delayms(10);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x0a
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	71; /home/valentin/.icaro/np05/source/user.c	if(sensordigital(24) ==1 ){
	CLRF	POSTDEC1
	MOVLW	0x18
	MOVWF	POSTDEC1
	CALL	_sensordigital
...
_00552_DS_:
	BRA	_00549_DS_
_00553_DS_:
;	.line	72; /home/valentin/.icaro/np05/source/user.c	PORTD=144;
	MOVLW	0x90
	MOVWF	_PORTD
;	.line	73; /home/valentin/.icaro/np05/source/user.c	Delayms(1000);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x03
	MOVWF	POSTDEC1
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	74; /home/valentin/.icaro/np05/source/user.c	PORTD=64;
	MOVLW	0x40
	MOVWF	_PORTD
;	.line	75; /home/valentin/.icaro/np05/source/user.c	Delayms(600);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x02
	MOVWF	POSTDEC1
...
_epapout_init:
;	.line	42; /home/valentin/.icaro/np05/source/main.c	void epapout_init() { return; }
	RETURN	

; ; Starting pCode block
S_main__epapin_init	code
_epapin_init:
;	.line	41; /home/valentin/.icaro/np05/source/main.c	void epapin_init() { return; }
	RETURN	

; ; Starting pCode block
S_main__epap_out	code
_epap_out:
;	.line	40; /home/valentin/.icaro/np05/source/main.c	void epap_out() { return; }
	RETURN	

; ; Starting pCode block
S_main__epap_in	code
_epap_in:
;	.line	39; /home/valentin/.icaro/np05/source/main.c	void epap_in() { return; }
	RETURN	
...
; Statistics:
; code size:	 5426 (0x1532) bytes ( 4.14%)
;           	 2713 (0x0a99) words
