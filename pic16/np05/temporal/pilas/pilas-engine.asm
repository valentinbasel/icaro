...
; This file was generated Wed Mar 11 12:54:20 2015
;--------------------------------------------------------
...
_loop:
;	.line	35; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	void loop()
...
;	.line	40; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	for(a=0;a<8;a++)
	CLRF	r0x00
	CLRF	r0x01
	CLRF	r0x02
	CLRF	r0x03
_00877_DS_:
;	.line	42; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	valor[a]=analogread(13+a);
	MOVLW	LOW(_loop_valor_1_186)
	ADDWF	r0x02, W
	MOVWF	r0x04
	MOVLW	HIGH(_loop_valor_1_186)
	ADDWFC	r0x03, W
	MOVWF	r0x05
	MOVF	r0x00, W
	MOVWF	r0x06
...
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 14), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 13), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 12), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 11), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 10), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 9), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 8), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 7), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 6), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 5), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 4), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 3), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 2), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	(_loop_valor_1_186 + 1), W, B
	MOVWF	POSTDEC1
; removed redundant BANKSEL
	MOVF	_loop_valor_1_186, W, B
	MOVWF	POSTDEC1
	MOVLW	UPPER(__str_0)
	MOVWF	POSTDEC1
	MOVLW	HIGH(__str_0)
	...
	MOVLW	0x80
	MOVWF	POSTDEC1
	MOVLW	HIGH(_loop_buf_1_186)
	MOVWF	POSTDEC1
	MOVLW	LOW(_loop_buf_1_186)
	MOVWF	POSTDEC1
	CALL	_sprintf
	MOVLW	0x16
	ADDWF	FSR1L, F
...
_setup:
;	.line	18; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	TRISB=0;
	CLRF	_TRISB
;	.line	19; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	pinmode(15,INPUT);
	CLRF	POSTDEC1
	MOVLW	0x01
	MOVWF	POSTDEC1
	CLRF	POSTDEC1
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	20; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	pinmode(21,INPUT);
	CLRF	POSTDEC1
	MOVLW	0x01
	MOVWF	POSTDEC1
	CLRF	POSTDEC1
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	21; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	pinmode(22,INPUT);
	CLRF	POSTDEC1
	MOVLW	0x01
	MOVWF	POSTDEC1
	CLRF	POSTDEC1
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	22; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	pinmode(23,INPUT);
	CLRF	POSTDEC1
	MOVLW	0x01
	MOVWF	POSTDEC1
	CLRF	POSTDEC1
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	23; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	pinmode(24,INPUT);
	CLRF	POSTDEC1
	MOVLW	0x01
	MOVWF	POSTDEC1
	CLRF	POSTDEC1
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	24; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	pinmode(25,OUTPUT);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x19
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	25; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	pinmode(26,OUTPUT);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x1a
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	26; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	pinmode(27,OUTPUT);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x1b
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	27; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	pinmode(28,OUTPUT);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x1c
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	28; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	ServoAttach(10);
	MOVLW	0x0a
	MOVWF	POSTDEC1
	CALL	_ServoAttach
	MOVF	POSTINC1, F
;	.line	29; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	ServoAttach(11);
	MOVLW	0x0b
	MOVWF	POSTDEC1
	CALL	_ServoAttach
	MOVF	POSTINC1, F
;	.line	30; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	ServoAttach(12);
	MOVLW	0x0c
	MOVWF	POSTDEC1
	CALL	_ServoAttach
	MOVF	POSTINC1, F
;	.line	31; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	ServoAttach(8);
	MOVLW	0x08
	MOVWF	POSTDEC1
	CALL	_ServoAttach
	MOVF	POSTINC1, F
;	.line	32; /home/valentin/.icaro/firmware/source/pilas/user-pilas.c	ServoAttach(9);
	MOVLW	0x09
	MOVWF	POSTDEC1
	CALL	_ServoAttach
	MOVF	POSTINC1, F
...
; ; Starting pCode block
__str_0:
	DB	0x20, 0x25, 0x69, 0x2c, 0x25, 0x69, 0x2c, 0x25, 0x69, 0x2c, 0x25, 0x69
	DB	0x2c, 0x25, 0x69, 0x2c, 0x25, 0x69, 0x2c, 0x25, 0x69, 0x2c, 0x25, 0x69
	DB	0x0a, 0x0d, 0x00


; Statistics:
; code size:	 6686 (0x1a1e) bytes ( 5.10%)
;           	 3343 (0x0d0f) words
