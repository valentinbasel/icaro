...
#define PACKAGE_BUGREPORT "vasco-project@lists.gforge.enseeiht.fr"

/* Define to the full name of this package. */
#define PACKAGE_NAME "docker"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "docker 1.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "docker"
