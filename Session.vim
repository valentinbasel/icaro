...
set shortmess=aoO
badd +41 icaro/workspace/icaro/carga.py
badd +247 icaro/workspace/icaro/icaro.py
silent! argdel *
edit icaro/workspace/icaro/carga.py
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 247 - ((17 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
247
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 232 - ((21 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
232
