...
map <F11> :set nopaste</f11></cr>
map <F10> :set paste</f10></cr>
map <C-PageDown> :tabn</c-pagedown></cr>
map <C-PageUp> :tabp</c-pageup></cr>
...
exe 'vert 2resize ' . ((&columns * 93 + 83) / 166)
exe 'vert 3resize ' . ((&columns * 40 + 83) / 166)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
