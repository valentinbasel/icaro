...
set shortmess=aoO
badd +0 icaro/workspace/icaro/hardware/icaro/modulos/docker.py
badd +0 icaro/workspace/icaro/icaro.py
badd +0 icaro/workspace/icaro/main.py
argglobal
silent! argdel *
edit icaro/workspace/icaro/hardware/icaro/modulos/docker.py
...
silent! normal! zE
let s:l = 120 - ((20 * winheight(0) + 20) / 41)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 163 - ((40 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
163
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 40 - ((20 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 139 - ((40 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
139
