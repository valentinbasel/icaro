...
;	.line	69; /home/vbasel/.icaro/v2/firmware/source/user.c	PORTB=analogread(13) *255/1023;
	MOVLW	0x0d
	MOVWF	POSTDEC1
	CALL	_analogread
	MOVWF	r0x00
	...
	MOVF	r0x00, W
	MOVWF	_PORTB
;	.line	70; /home/vbasel/.icaro/v2/firmware/source/user.c	Delayms(100);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x64
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	71; /home/vbasel/.icaro/v2/firmware/source/user.c	PORTD=0;
	CLRF	_PORTD
	MOVFF	PREINC1, r0x01
	MOVFF	PREINC1, r0x00
	RETURN	
...
; Statistics:
; code size:	 5946 (0x173a) bytes ( 4.54%)
;           	 2973 (0x0b9d) words
