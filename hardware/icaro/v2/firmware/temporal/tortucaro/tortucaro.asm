...
_01709_DS_:
	...
	RLCF	PCLATH, F
	ANDLW	0xfc
	ADDLW	LOW(_01710_DS_)
	MOVWF	POSTDEC1
	MOVLW	HIGH(_01710_DS_)
	ADDWFC	PCLATH, F
	MOVLW	UPPER(_01710_DS_)
	ADDWFC	PCLATU, F
	MOVF	PREINC1, W
	MOVWF	PCL
_01710_DS_:
...
;	.line	114; /home/vbasel/.icaro/v2/firmware/source/tortucaro/user-tortucaro.c	x_ftoa(valor,chaine,2,2);
	...
	MOVWF	POSTDEC1
	MOVWF	POSTDEC1
	MOVLW	HIGH(_analogico_chaine_1_256)
	MOVWF	POSTDEC1
	MOVLW	LOW(_analogico_chaine_1_256)
	MOVWF	POSTDEC1
	MOVF	r0x03, W
	MOVWF	POSTDEC1
	MOVF	r0x02, W
...
_01590_DS_:
	...
	RLCF	PCLATH, F
	ANDLW	0xfc
	ADDLW	LOW(_01591_DS_)
	MOVWF	POSTDEC1
	MOVLW	HIGH(_01591_DS_)
	ADDWFC	PCLATH, F
	MOVLW	UPPER(_01591_DS_)
	ADDWFC	PCLATU, F
	MOVF	PREINC1, W
	MOVWF	PCL
_01591_DS_:
