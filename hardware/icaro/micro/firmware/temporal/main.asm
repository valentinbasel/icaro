...
; This file was generated Thu Apr 23 13:22:04 2015
;--------------------------------------------------------
...
;	.line	60; /home/valentin/.icaro/firmware/source/main.c	setup();
	CALL	_setup
;	.line	62; /home/valentin/.icaro/firmware/source/main.c	analog_init();
	CALL	_analog_init
...
S_main__loop	code
_loop:
;	.line	86; /home/valentin/.icaro/firmware/source/user.c	}
	RETURN	

; ; Starting pCode block
S_main__sensordigital	code
_sensordigital:
;	.line	68; /home/valentin/.icaro/firmware/source/user.c	int sensordigital(int valor)
	...
	MOVLW	0x03
	MOVFF	PLUSW2, r0x01
;	.line	72; /home/valentin/.icaro/firmware/source/user.c	temp=digitalread(valor);
	MOVF	r0x01, W
	MOVWF	POSTDEC1
	MOVF	r0x00, W
	MOVWF	POSTDEC1
	...
	MOVF	POSTINC1, F
	MOVF	POSTINC1, F
;	.line	73; /home/valentin/.icaro/firmware/source/user.c	if (temp==0)
	IORWF	r0x01, W
	BNZ	_00761_DS_
;	.line	75; /home/valentin/.icaro/firmware/source/user.c	return 1;
	CLRF	PRODL
	MOVLW	0x01
	BRA	_00763_DS_
_00761_DS_:
;	.line	79; /home/valentin/.icaro/firmware/source/user.c	return 0;
	CLRF	PRODL
	CLRF	WREG
_00763_DS_:
	MOVFF	PREINC1, r0x01
...
S_main__setup	code
_setup:
;	.line	41; /home/valentin/.icaro/firmware/source/user.c	TRISB=0; //defino PORTB como salida
	CLRF	_TRISB
;	.line	42; /home/valentin/.icaro/firmware/source/user.c	PORTB=0; 
	CLRF	_PORTB
;	.line	43; /home/valentin/.icaro/firmware/source/user.c	PORTD=0;
	CLRF	_PORTD
;	.line	44; /home/valentin/.icaro/firmware/source/user.c	pinmode(ICR_DIG1,INPUT);
	CLRF	POSTDEC1
	MOVLW	0x01
	MOVWF	POSTDEC1
	CLRF	POSTDEC1
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	45; /home/valentin/.icaro/firmware/source/user.c	pinmode(ICR_DIG2,INPUT);
	CLRF	POSTDEC1
	MOVLW	0x01
	MOVWF	POSTDEC1
	CLRF	POSTDEC1
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	47; /home/valentin/.icaro/firmware/source/user.c	pinmode(ICR_DIG3,TRIG);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x17
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	48; /home/valentin/.icaro/firmware/source/user.c	pinmode(ICR_DIG4,ECHO);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x18
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	49; /home/valentin/.icaro/firmware/source/user.c	pinmode(ICR_l293_P1,OUTPUT);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x19
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	50; /home/valentin/.icaro/firmware/source/user.c	pinmode(ICR_l293_P2,OUTPUT);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x1a
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	51; /home/valentin/.icaro/firmware/source/user.c	pinmode(ICR_l293_P3,OUTPUT);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x1b
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	52; /home/valentin/.icaro/firmware/source/user.c	pinmode(ICR_l293_P4,OUTPUT);
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	CLRF	POSTDEC1
	MOVLW	0x1c
	...
	MOVLW	0x04
	ADDWF	FSR1L, F
;	.line	53; /home/valentin/.icaro/firmware/source/user.c	ServoAttach(ICR_SRV1);
	MOVLW	0x0a
	MOVWF	POSTDEC1
	CALL	_ServoAttach
	MOVF	POSTINC1, F
;	.line	54; /home/valentin/.icaro/firmware/source/user.c	ServoAttach(ICR_SRV2);
	MOVLW	0x0b
	MOVWF	POSTDEC1
	CALL	_ServoAttach
	MOVF	POSTINC1, F
;	.line	55; /home/valentin/.icaro/firmware/source/user.c	ServoAttach(ICR_SRV3);
	MOVLW	0x0c
	MOVWF	POSTDEC1
	CALL	_ServoAttach
	MOVF	POSTINC1, F
;	.line	56; /home/valentin/.icaro/firmware/source/user.c	ServoAttach(ICR_SRV4);
	MOVLW	0x08
	MOVWF	POSTDEC1
	CALL	_ServoAttach
	MOVF	POSTINC1, F
;	.line	57; /home/valentin/.icaro/firmware/source/user.c	ServoAttach(ICR_SRV5);
	MOVLW	0x09
	MOVWF	POSTDEC1
	CALL	_ServoAttach
	MOVF	POSTINC1, F
