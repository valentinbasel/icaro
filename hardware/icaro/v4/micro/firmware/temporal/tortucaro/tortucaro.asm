...
_01706_DS_:
	...
	RLCF	PCLATH, F
	ANDLW	0xfc
	ADDLW	LOW(_01707_DS_)
	MOVWF	POSTDEC1
	MOVLW	HIGH(_01707_DS_)
	ADDWFC	PCLATH, F
	MOVLW	UPPER(_01707_DS_)
	ADDWFC	PCLATU, F
	MOVF	PREINC1, W
	MOVWF	PCL
_01707_DS_:
...
_01587_DS_:
	...
	RLCF	PCLATH, F
	ANDLW	0xfc
	ADDLW	LOW(_01588_DS_)
	MOVWF	POSTDEC1
	MOVLW	HIGH(_01588_DS_)
	ADDWFC	PCLATH, F
	MOVLW	UPPER(_01588_DS_)
	ADDWFC	PCLATU, F
	MOVF	PREINC1, W
	MOVWF	PCL
_01588_DS_:
...
_01556_DS_:
	...
	RLCF	PCLATH, F
	ANDLW	0xfc
	ADDLW	LOW(_01557_DS_)
	MOVWF	POSTDEC1
	MOVLW	HIGH(_01557_DS_)
	ADDWFC	PCLATH, F
	MOVLW	UPPER(_01557_DS_)
	ADDWFC	PCLATU, F
	MOVF	PREINC1, W
	MOVWF	PCL
_01557_DS_:
