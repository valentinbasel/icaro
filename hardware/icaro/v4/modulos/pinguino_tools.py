...
class PinguinoTools(object):
    ...
    def set_os_variables(self):
        ...
        if os.getenv("PINGUINO_OS_NAME") == "windows":
            ...
            self.COMPILER_8BIT = os.path.join(self.P8_BIN, "sdcc-sdcc")
            #self.p8 = 'picpgm'
    ...
    def compile(self, filename):
        ...
        if board.bldr == 'boot2':
            ...
            sortie = Popen([self.COMPILER_8BIT,
                ...
                "-I" + os.path.join(self.P8_DIR, 'include', 'pinguino', 'core'),\
                "-I" + os.path.join(self.P8_DIR, 'include', 'pinguino', 'libraries'),\
                "-I" + " /home/vbasel/.icaro/firmware/non-free/include/pic16",\
                "-I" + os.path.dirname(filename),\
                "--compile-only",\
            ...
            archivo=[self.COMPILER_8BIT,
                ...
                "-o" + os.path.join(os.path.expanduser(self.SOURCE_DIR), 'main.o')] + user_imports
            print archivo
            p=open("/home/vbasel/sdcc.txt","w")
            p.writelines(archivo)
            p.close()
    ...
    def link(self, filename):
        ...
        if board.arch == 8:
            ...
            if board.bldr == 'boot2':
                ...
                print archivo
                p=open("/home/vbasel/sdcc_link.txt","w")
                p.writelines(archivo)
                p.close()
