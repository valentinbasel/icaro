...
class componente_un_arg(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y,identidad,color,texto,fondo,ventana,textorender):
        pygame.sprite.Sprite.__init__(self)
        #self.imagen=pygame.image.load("imagenes/componentes/componente_un_arg.png")
...
class componente_dos_arg(pygame.sprite.Sprite):
    # el componente cuadrado es el bloque minimo que puede tener un
    # icaro-block
    pulsado=0
    posicion=(0,0)
    rectan=pygame.Rect(0,0,60,100)#rectangulo que representa toda el area del componente
    conector_m=pygame.Rect(0,0,40,10)#conector macho
    conector_h=pygame.Rect(0,0,40,10)#conector hembra
    conector_h_dato=pygame.Rect(0,0,40,20)#conector hembra dato
    conector_h_dato2=pygame.Rect(0,0,40,20)#conector hembra dato2
    ide=0
    color=(110,20,90)
    texto=""
    def __init__(self,x,y,identidad,color,texto,fondo,ventana,textorender):
        pygame.sprite.Sprite.__init__(self)
        #self.imagen=pygame.image.load("imagenes/componentes/componente_dos_arg.png")
    ...
    def dibujar(self):
#        self.fondo.screen.blit(self.imagen,(self.posicion[0],self.posicion[1]-12))

        # estos son los cuadrados que forman el vacio que representa el conector hembra
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0],self.posicion[1]-10, 10,10),0)
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+50,self.posicion[1]-10, 10,10),0)
        # el cuerpo del componente
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0],self.posicion[1], 60,90),0)
        # el conector macho
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+10,self.posicion[1]+90, 40,10),0)
        # conector hembra datos
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+60,self.posicion[1], 10,10),0)
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+60,self.posicion[1]+30, 10,10),0)
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+60,self.posicion[1]+40, 10,10),0)
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+60,self.posicion[1]+70, 10,10),0)
...
#        texto.render(str(self.ide),self.color_texto,((self.posicion[0]+10),(self.posicion[1]+10)))
    ...
    def update(self):
        ...
        # self.conector_m es la ficha "macho"
        self.conector_m[0]=self.rectan[0]+10
        self.conector_m[1]=self.rectan[1]+100
        # self.conector_h es la ficha "hembra"
        self.conector_h[0]=self.rectan[0]+10
        self.conector_h[1]=self.rectan[1]
        ...
        self.conector_h_dato2[1]=self.rectan[1]+60
        #cargo la lista de los dos conectores hembra y macho
        self.fondo.lista_ch_dato[self.ide]=(self.conector_h_dato[0],self.conector_h_dato[1],self.conector_h_dato[2],self.conector_h_dato[3])
        self.fondo.lista_ch_dato[self.ide+1]=(self.conector_h_dato2[0],self.conector_h_dato2[1],self.conector_h_dato2[2],self.conector_h_dato2[3])
...
class componente_bloque_uno_tres_arg(pygame.sprite.Sprite):
    # el componente cuadrado es el bloque minimo que puede tener un
    # icaro-block
    pulsado=0
    posicion=(0,0)
    ...
    conector_h_dato=pygame.Rect(0,0,40,20)#conector hembra dato
    conector_h_dato2=pygame.Rect(0,0,40,20)#conector hembra dato2
    conector_h_dato3=pygame.Rect(0,0,40,20)#conector hembra dato3
    ide=0
    color=(170,136,0)
    cadena=""
    def __init__(self,x,y,identidad,color,texto,fondo,ventana,textorender):
        ...
        self.fondo.lista_fina.append(0)
        self.fondo.lista_parser.append(texto)
        fondo.lista_parser_final.append(texto)
        self.fondo.lista_cm.append((0,0,0,0))
        self.fondo.lista_ch.append((0,0,0,0))
        self.fondo.lista_ch_dato.append((0,0,0,0))
    ...
    def dibujar(self):
        ...
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+50,self.posicion[1]-10, 10,10),0)
        # el cuerpo del componente
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0],self.posicion[1], 120,120),0)
        
        
        # el conector macho
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+70,self.posicion[1]+120, 40,10),0)
        # conector hembra datos
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+120,self.posicion[1], 10,10),0)
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+120,self.posicion[1]+30, 10,10),0)
        ...
        # conector hembra datos
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+120,self.posicion[1]+40, 10,10),0)
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+120,self.posicion[1]+70, 10,10),0)
        
        # conector hembra datos
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+120,self.posicion[1]+80, 10,10),0)
        pygame.draw.rect(self.fondo.screen,self.color,(self.posicion[0]+120,self.posicion[1]+110, 10,10),0)
...
#        texto.render(str(self.ide),self.color_texto,((self.posicion[0]+10),(self.posicion[1]+10)))
    ...
    def update(self):
        ...
        # self.conector_m es la ficha "macho"
        self.conector_m[0]=self.rectan[0]+70
        self.conector_m[1]=self.rectan[1]+130
        # self.conector_h es la ficha "hembra"
        self.conector_h[0]=self.rectan[0]+10
        self.conector_h[1]=self.rectan[1]
        ...
        self.conector_h_dato2[0]=self.rectan[0]+120
        self.conector_h_dato2[1]=self.rectan[1]+60

        self.conector_h_dato3[0]=self.rectan[0]+120
        self.conector_h_dato3[1]=self.rectan[1]+100

        #cargo la lista de los dos conectores hembra y macho
        self.fondo.lista_ch_dato[self.ide]=(self.conector_h_dato[0],self.conector_h_dato[1],self.conector_h_dato[2],self.conector_h_dato[3])
        self.fondo.lista_ch_dato[self.ide+1]=(self.conector_h_dato2[0],self.conector_h_dato2[1],self.conector_h_dato2[2],self.conector_h_dato2[3])
        self.fondo.lista_ch_dato[self.ide+2]=(self.conector_h_dato3[0],self.conector_h_dato3[1],self.conector_h_dato3[2],self.conector_h_dato3[3])
