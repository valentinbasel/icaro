...
class componente_bloque_uno(ComponenteCentral):
    pulsado=0
    rectan=[0,0,60,60]#rectangulo que representa toda el area del componente
    ...
    def dibujar(self):
        ...
        self.fondo.texto(self.texto,(self.posicion[0]+10),(self.posicion[1]+20),self.color_texto,self.ventana.cr)
