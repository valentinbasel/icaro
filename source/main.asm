...
; This file was generated Sat Dec 15 14:48:24 2012
;--------------------------------------------------------
...
_high_priority_isr:
;	.line	103; /home/valentin/github/icaro-bloques/source/main.c	void high_priority_isr(void) interrupt
	MOVFF	WREG, POSTDEC1
...
;	.line	139; /home/valentin/github/icaro-bloques/source/main.c	servos_interrupt();
...
_low_priority_isr:
;	.line	147; /home/valentin/github/icaro-bloques/source/main.c	void low_priority_isr(void) interrupt
	MOVFF	WREG, POSTDEC1
	MOVFF	STATUS, POSTDEC1
	MOVFF	BSR, POSTDEC1
	MOVFF	PRODL, POSTDEC1
	...
	MOVFF	PCLATH, POSTDEC1
	MOVFF	PCLATU, POSTDEC1
;	.line	149; /home/valentin/github/icaro-bloques/source/main.c	}
	MOVFF	PREINC1, PCLATU
	MOVFF	PREINC1, PCLATH
	MOVFF	PREINC1, FSR0H
	MOVFF	PREINC1, FSR0L
...
_pinguino_main:
;	.line	59; /home/valentin/github/icaro-bloques/source/main.c	PIE1=0;
	CLRF	_PIE1
;	.line	60; /home/valentin/github/icaro-bloques/source/main.c	PIE2=0;
	CLRF	_PIE2
;	.line	61; /home/valentin/github/icaro-bloques/source/main.c	ADCON1=0x0F;
	MOVLW	0x0f
	MOVWF	_ADCON1
;	.line	66; /home/valentin/github/icaro-bloques/source/main.c	setup();
	CALL	_setup
;	.line	68; /home/valentin/github/icaro-bloques/source/main.c	analog_init();
	CALL	_analog_init
;	.line	74; /home/valentin/github/icaro-bloques/source/main.c	servos_init();
	CALL	_servos_init
;	.line	90; /home/valentin/github/icaro-bloques/source/main.c	INTCONbits.PEIE=1;
	BSF	_INTCONbits, 6
;	.line	91; /home/valentin/github/icaro-bloques/source/main.c	INTCONbits.GIE=1;
	BSF	_INTCONbits, 7
_00553_DS_:
;	.line	96; /home/valentin/github/icaro-bloques/source/main.c	loop();
	CALL	_loop
	BRA	_00553_DS_
	RETURN	
...
_epapout_init:
;	.line	47; /home/valentin/github/icaro-bloques/source/main.c	void epapout_init() { return; }
	RETURN	

; ; Starting pCode block
S_main__epapin_init	code
_epapin_init:
;	.line	46; /home/valentin/github/icaro-bloques/source/main.c	void epapin_init() { return; }
	RETURN	

; ; Starting pCode block
S_main__epap_out	code
_epap_out:
;	.line	45; /home/valentin/github/icaro-bloques/source/main.c	void epap_out() { return; }
	RETURN	

; ; Starting pCode block
S_main__epap_in	code
_epap_in:
;	.line	44; /home/valentin/github/icaro-bloques/source/main.c	void epap_in() { return; }
	RETURN	
...
; Statistics:
; code size:	 5308 (0x14bc) bytes ( 4.05%)
;           	 2654 (0x0a5e) words
